...
var material = new THREE.MeshLambertMaterial({
  map: textureLoader.load('images/enus.jpg'),
  shading: THREE.SmoothShading
});
...
// faredge
var FarEdgeSize = 40.3;
// var FarEdgeOrbitRadius = sunSize + (AU * 15.1);
// var FarEdgeOrbitAngle = getRandomArbitrary(0, 360);
// var FarEdgeOrbitSpeed = 0.1;
// var FarEdgeRotateSpeed = 0.04;

// var FarEdgeMaterial = new THREE.MeshLambertMaterial({
//   map: textureLoader.load('images/FarEdge.jpg'),
//   shading: THREE.SmoothShading
// });

// var faredge = new THREE.Mesh(new THREE.SphereGeometry(FarEdgeSize, 10, 15), FarEdgeMaterial);
// scene.add(faredge);
...
function animate() {
  ...
  // faredge text around faredge logo
  // FarEdgeOrbitAngle -= FarEdgeOrbitSpeed;
  // var radians = FarEdgeOrbitAngle * Math.PI/180;
  // faredge.position.x = Math.cos(radians) * FarEdgeOrbitRadius;
  // faredge.position.z = Math.sin(radians) * FarEdgeOrbitRadius;
  // faredge.position.y += FarEdgeRotateSpeed;
  farEdgeText.position.x =   -50;
  farEdgeText.position.y =   10;
  farEdgeText.position.z =   -30;
  console.log("x "+farEdgeText.position.x+"y "+farEdgeText.position.y+"z"+farEdgeText.position.z);
  // farEdgeText.needsUpdate = false;
